...
function runInterval(){
    async.waterfall([
        ...
        function(blocks, callback){
            async.filter(blocks, function(block, mapCback){
                ...
                apiInterfaces.rpcDaemon('get_block_header_by_height', {height: block.height}, function(error, result){
                    if (error){  
                      log('error', logSystem, 'Error with blockheaderbyheight RPC request for block %s - %j', [block.serialized, error]);
        ...
        function(blocks, callback){
            ...
            //console.log('unlockedBlocksCommands = ' + unlockedBlocksCommands + '\n');
            //console.log('totalBlocksUnlocked = ' + totalBlocksUnlocked + '\n');
